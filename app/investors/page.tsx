    ...
    <main className="min-h-screen bg-white text-zinc-900 pt-32 px-8 md:px-24">
      <div className="max-w-4xl">
        ...
        <p className="text-zinc-500 text-lg leading-relaxed max-w-2xl">
          Strategic asset allocation in ultra-prime real estate.
          We deliver risk-adjusted returns through architectural innovation and market dominance.
        </p>
      </div>

      <div className="mt-24 h-96 w-full bg-zinc-50 flex flex-col items-center justify-center border border-rosegold/20">
        <span className="text-zinc-500 text-xs tracking-widest uppercase mb-4">Financial Performance Dashboard</span>
